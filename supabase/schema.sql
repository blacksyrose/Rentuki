...
--
-- Name: can_access_property(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.can_access_property(p_property_id uuid) RETURNS boolean
...
--
-- Name: create_tenancy(uuid, uuid, date, numeric, integer, numeric, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_tenancy(p_tenant_id uuid, p_unit_id uuid, p_start_date date, p_monthly_rent numeric, p_payment_due_day integer, p_deposit_amount numeric DEFAULT 0, p_notes text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: generate_tenant_portal_key(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.generate_tenant_portal_key(p_tenant_id uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: get_tenant_monthly_summary(text, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_tenant_monthly_summary(p_access_key text, p_month date DEFAULT (date_trunc('month'::text, (CURRENT_DATE)::timestamp with time zone))::date) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'extensions'
    AS $$
declare
...
--
-- Name: list_tenant_portal_keys(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.list_tenant_portal_keys() RETURNS TABLE(tenant_id uuid, key_preview text, created_at timestamp with time zone, last_used_at timestamp with time zone, revoked_at timestamp with time zone)
...
--
-- Name: move_out_tenant(date, text, uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.move_out_tenant(p_move_out_date date, p_notes text, p_tenancy_id uuid, p_tenant_id uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: payments_status_trigger(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.payments_status_trigger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  billing_id uuid;
...
--
-- Name: prevent_tenancy_overlap(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_tenancy_overlap() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  if exists (
...
--
-- Name: refresh_billing_status(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.refresh_billing_status(p_billing_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: revoke_tenant_portal_key(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.revoke_tenant_portal_key(p_tenant_id uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'extensions'
    AS $$
declare
...
--
-- Name: set_expense_property_id(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_expense_property_id() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
begin
...
--
-- Name: tenant_portal_summary(text, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.tenant_portal_summary(p_access_key text, p_billing_month date) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
begin
  ...
  /*
   * The key is generated randomly in Settings and stored on the tenant.
   * Comparison is case-insensitive and ignores accidental surrounding
   * whitespace from manual entry.
   */
  select
    t.id,
    t.first_name,
  ...
  /*
   * Current property name comes from the active unit.
   */
  select p.name
  into v_property_name
  from public.tenancies te
  ...
  /*
   * Billing for the requested month and only the tenant's current tenancy.
   */
  select jsonb_build_object(
    'id', br.id,
...
--
-- Name: transfer_tenant(uuid, uuid, uuid, date, numeric, integer, numeric, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.transfer_tenant(p_tenancy_id uuid, p_tenant_id uuid, p_new_unit_id uuid, p_transfer_date date, p_new_rent numeric, p_new_due_day integer, p_new_deposit numeric DEFAULT 0, p_notes text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
CREATE TABLE public.billing_records (
    ...
    status public.billing_status DEFAULT 'upcoming'::public.billing_status NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: tenant_portal_access; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.units (
    ...
    floor text,
    unit_type text,
    default_rent numeric(12,2) DEFAULT 0 NOT NULL,
    status public.unit_status DEFAULT 'available'::public.unit_status NOT NULL,
    notes text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    electricity_meter_type text DEFAULT 'direct'::text NOT NULL,
...
--
-- Name: billing_records billing_records_tenancy_id_billing_month_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.billing_records
    ADD CONSTRAINT billing_records_tenancy_id_billing_month_key UNIQUE (tenancy_id, billing_month);
...
--
-- Name: tenant_portal_access tenant_portal_access_key_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tenant_portal_access
    ADD CONSTRAINT tenant_portal_access_key_hash_key UNIQUE (key_hash);


--
-- Name: tenant_portal_access tenant_portal_access_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tenant_portal_access
    ADD CONSTRAINT tenant_portal_access_pkey PRIMARY KEY (id);
...
--
-- Name: idx_billing_month; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_billing_tenancy; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tenancies_tenant; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tenancies_unit; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: tenant_portal_access_active_tenant_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX tenant_portal_access_active_tenant_key ON public.tenant_portal_access USING btree (tenant_id) WHERE (revoked_at IS NULL);


--
-- Name: tenant_portal_access_owner_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: tenants_tenant_access_key_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX tenants_tenant_access_key_unique ON public.tenants USING btree (tenant_access_key) WHERE (tenant_access_key IS NOT NULL);
...
--
-- Name: maintenance_requests audit_maintenance; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER audit_maintenance AFTER INSERT OR UPDATE ON public.maintenance_requests FOR EACH ROW EXECUTE FUNCTION public.audit_row();
...
CREATE TRIGGER audit_tenancies AFTER INSERT OR UPDATE ON public.tenancies FOR EACH ROW EXECUTE FUNCTION public.audit_row();
...
CREATE TRIGGER audit_tenants AFTER INSERT OR UPDATE ON public.tenants FOR EACH ROW EXECUTE FUNCTION public.audit_row();


--
-- Name: payments payment_receipt_number; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER payment_receipt_number BEFORE INSERT ON public.payments FOR EACH ROW EXECUTE FUNCTION public.assign_receipt_number();


--
-- Name: payments payment_status_refresh; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER payment_status_refresh AFTER INSERT OR DELETE OR UPDATE ON public.payments FOR EACH ROW EXECUTE FUNCTION public.payments_status_trigger();


--
-- Name: expenses set_expense_property_id_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_expense_property_id_trigger BEFORE INSERT OR UPDATE ON public.expenses FOR EACH ROW EXECUTE FUNCTION public.set_expense_property_id();


--
-- Name: tenancies tenancy_overlap_guard; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER tenancy_overlap_guard BEFORE INSERT OR UPDATE ON public.tenancies FOR EACH ROW EXECUTE FUNCTION public.prevent_tenancy_overlap();
...
--
-- Name: billing_records billing_records_tenancy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: documents documents_expense_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: documents documents_payment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: documents documents_tenancy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: expenses expenses_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments payments_billing_record_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments payments_tenancy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenancies tenancies_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_portal_access tenant_portal_access_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenant_portal_access tenant_portal_access_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: audit_logs audit_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY audit_owner ON public.audit_logs FOR SELECT USING ((user_id = auth.uid()));


--
-- Name: billing_records billing_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY billing_owner ON public.billing_records USING ((EXISTS ( SELECT 1
   FROM (public.tenancies t
     JOIN public.tenants tn ON ((tn.id = t.tenant_id)))
  WHERE ((t.id = billing_records.tenancy_id) AND (tn.owner_id = auth.uid()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM (public.tenancies t
     JOIN public.tenants tn ON ((tn.id = t.tenant_id)))
...
--
-- Name: documents documents_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY documents_owner ON public.documents USING ((((tenant_id IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM public.tenants t
  ...
  WHERE ((m.id = documents.maintenance_request_id) AND public.can_access_property(m.property_id))))))) WITH CHECK ((((tenant_id IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM public.tenants t
  WHERE ((t.id = documents.tenant_id) AND (t.owner_id = auth.uid()))))) OR ((tenancy_id IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM (public.tenancies te
     JOIN public.tenants t ON ((t.id = te.tenant_id)))
...
CREATE POLICY expenses_owner ON public.expenses USING (public.can_access_property(property_id)) WITH CHECK (public.can_access_property(property_id));


--
-- Name: maintenance_requests maintenance_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY maintenance_owner ON public.maintenance_requests USING (public.can_access_property(property_id)) WITH CHECK (public.can_access_property(property_id));
...
CREATE POLICY payments_owner ON public.payments USING ((EXISTS ( SELECT 1
   FROM public.tenants t
  WHERE ((t.id = payments.tenant_id) AND (t.owner_id = auth.uid()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tenants t
...
CREATE POLICY properties_owner ON public.properties USING ((owner_id = auth.uid())) WITH CHECK ((owner_id = auth.uid()));
...
--
-- Name: receipts receipts_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY receipts_owner ON public.receipts USING ((EXISTS ( SELECT 1
   FROM (public.payments p
     JOIN public.tenants t ON ((t.id = p.tenant_id)))
  WHERE ((p.id = receipts.payment_id) AND (t.owner_id = auth.uid()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM (public.payments p
     JOIN public.tenants t ON ((t.id = p.tenant_id)))
...
--
-- Name: tenancies tenancies_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tenancies_owner ON public.tenancies USING ((EXISTS ( SELECT 1
   FROM public.tenants t
  WHERE ((t.id = tenancies.tenant_id) AND (t.owner_id = auth.uid()))))) WITH CHECK (((EXISTS ( SELECT 1
   FROM public.tenants t
...
--
-- Name: tenant_portal_access tenant portal owner delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant portal owner delete" ON public.tenant_portal_access FOR DELETE TO authenticated USING ((owner_id = auth.uid()));


--
-- Name: tenant_portal_access tenant portal owner read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "tenant portal owner read" ON public.tenant_portal_access FOR SELECT TO authenticated USING ((owner_id = auth.uid()));


--
-- Name: tenant_portal_access; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: tenants tenants_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tenants_owner ON public.tenants USING ((owner_id = auth.uid())) WITH CHECK ((owner_id = auth.uid()));
...
--
-- Name: units units_owner; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY units_owner ON public.units USING (public.can_access_property(property_id)) WITH CHECK (public.can_access_property(property_id));
...
--
-- Name: objects rental docs delete own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "rental docs delete own" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'rental-documents'::text) AND (owner = auth.uid())));


--
-- Name: objects rental docs insert own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "rental docs insert own" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'rental-documents'::text) AND (owner = auth.uid())));


--
-- Name: objects rental docs read own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "rental docs read own" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'rental-documents'::text) AND (owner = auth.uid())));


--
-- Name: objects rental docs update own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "rental docs update own" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'rental-documents'::text) AND (owner = auth.uid()))) WITH CHECK (((bucket_id = 'rental-documents'::text) AND (owner = auth.uid())));
