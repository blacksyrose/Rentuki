-- Fix: align record_payment() with the Payments UI's Received By field.
-- The previous RPC accepted 9 parameters and did not persist received_by.
-- This migration replaces that signature with the 10-parameter version used
-- by the frontend. No table/schema change is required if received_by already exists.
