-- Tenant portal dashboard data extension.
-- Exposes existing tenant contact fields and existing property contact fields
-- through the existing tenant_portal_summary RPC. No tables or columns are added.
...
BEGIN
  ...
  INTO v_property_name, v_property_address, v_property_phone
  FROM public.tenancies te
  JOIN public.units u ON u.id = te.unit_id
  ...
  RETURN jsonb_build_object(
    ...
    'property_phone', v_property_phone,
